...
for i = 1:N
    ...
    while(1)
        dq = Phi_q(params,q)\Phi(params,t(i),q); % Defining the change
    ...
    w_dot(:,i) = Phi_q(params,q)\Nu(params);                % Defining Velocity
    w_ddot(:,i) = Phi_q(params,q)\Gamma(params,q,w_dot);   % Defining Acceleration
end
