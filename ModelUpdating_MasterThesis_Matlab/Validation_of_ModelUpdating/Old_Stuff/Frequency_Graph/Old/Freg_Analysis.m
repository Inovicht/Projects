...
format short
addpath([cd,'/Scripts/'])
Data = readmatrix("Good_Data_domi_reduced.csv");
...
% figure; 
% histogram(imag(est_poles),20,'Normalization','probability');
% hold on;
% plot(pxI,pyI,'LineWidth',1);
% set(get(gcf,'CurrentAxes'),'FontName','Times New Roman','FontSize',10)
% xlabel('$\Im(\lambda_1)$','FontName','Times New Roman','FontSize',10,'Interpreter','latex')
% ylabel('Probability density','FontName','Times New Roman','FontSize',10,'Interpreter','latex')
% xlim([2.55 2.65])
% legend('Histogram of $\Im(\lambda_1)$','Delta method','FontName','Times New Roman','FontSize',10,'Interpreter','latex')
