...
format short
addpath([cd,'/Scripts/'])
Data = readmatrix("Data_N20It100F53192.1399.csv");
...
legend("First natural frequency","Second natural frequency",'Location','best')
ylim([0 2e4]);
xlim(uf)
set(gca,'xscale','log','FontName','cmr15')
title("\textbf{Natural frequency over rotational stiffness}",'FontName','Times New Roman','FontSize',12,'Interpreter','latex')
grid on
xlabel("Rotational Stiffness (Nm/rad)",'FontName','Times New Roman','FontSize',12,'Interpreter','latex')
ylabel("Natural frequency (rad/s)",'FontName','Times New Roman','FontSize',12,'Interpreter','latex')
hold off
% figure(2)
% hold on
% xlim(uf)
...
xlim(uf)
set(gca,'xscale','log','FontName','cmr15')
title("\textbf{Natural frequencies over translational stiffness}",'FontName','Times New Roman','FontSize',12,'Interpreter','latex')
grid on
...
colormap([1 1 1])
set(gca,'xscale','log','YScale','log')
title("\textbf{Behavior of second natural frequency}",'FontName','Times New Roman','FontSize',12,'Interpreter','latex');
mehx = xlabel("Rotational Stiffness (Nm/rad)",'FontName','Times New Roman','FontSize',12,'Interpreter','latex');
%mehx.Position = mehx.Position + [30000 0 0];
mehy = ylabel("Translational Stiffness (N/m)",'FontName','Times New Roman','FontSize',12,'Interpreter','latex');
mehy.Position = mehy.Position - [-0 -200000 -0.14];
